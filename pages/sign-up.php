...
<head>
  ...
  <title>My Storage | Sign in </title>
  <!--     Fonts and icons     -->
...
<body class="">
  ...
  <nav class="navbar navbar-expand-lg position-absolute top-0 z-index-3 w-100 shadow-none my-3 navbar-transparent mt-4">
    <div class="container">
      <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 text-white" href="../pages/sign-up.php">
        My Storage
      </a>
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="navbar-nav mx-auto">
          <li class="nav-item">
            <a class="nav-link me-8" href="../pages/sign-up.php">
              <i class="fas fa-user-circle opacity-6  me-1"></i>
              Sign Up
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link me-8" href="../pages/sign-in.php">
...
if(isset($_POST['insert']))
{
    ...
    $tparol=mysqli_real_escape_string($con,htmlspecialchars(strip_tags(trim($_POST['tparol']))));
  ...
  if(!empty($ad) && !empty($soyad) && !empty($telefon) && !empty($email) && !empty($parol) && !empty($tparol))
{
  ...
  if($parol==$tparol)
{
  $daxil=mysqli_query($con,"INSERT INTO users(ad,soyad,telefon,email,parol,tarix) VALUES('".$ad."','".$soyad."','".$telefon."','".$email."','".$parol."','".$tarix."')");
...
?>
            <div class="card-body">
              <form method="post">
                <form role="form">
                  <div class="mb-3">
                    <input type="text" class="form-control" name="ad" placeholder="Name" aria-label="Name">
                  </div>
                  <div class="mb-3">
                    <input type="text" class="form-control" name="soyad" placeholder="Surname" aria-label="Surname">
                  </div>
                  <div class="mb-3">
                    <input type="email" class="form-control" name="email" placeholder="Email" aria-label="Email">
                  </div>
                  <div class="mb-3">
                    <input type="text" class="form-control" name="telefon" placeholder="Phone" aria-label="Phone">
                  </div>
                  <div class="mb-3">
                  ...
                  <div class="mb-3">
                    <input type="password" class="form-control" name="tparol" placeholder="Again Password"
                      aria-label="Again Password">
                  </div>
                  ...
                  <div class="text-center">
                    <button type="submit" name="insert" class="btn bg-gradient-dark w-100 my-4 mb-2">Sign up</button>
                  </div>
                  <p class="text-sm mt-3 mb-0">Already have an account? <a href="../pages/sign-in.php"
