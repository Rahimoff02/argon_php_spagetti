...
if(isset($_POST['update']))
{
   ...
   if($_POST['parol']==$_SESSION['parol'])

  {
    $yoxla=mysqli_query($con,"SELECT * FROM users WHERE (telefon='".$_SESSION['telefon']."' OR email='".$_SESSION['email']."') AND id!= '".$_SESSION['user_id']."' ");
    ...
    if($say==0)
  {
    ...
    {$parol = mysqli_real_escape_string($con,htmlspecialchars(strip_tags(trim($_POST['yparol']))));}
  }
  ...
  if(!empty($ad) && !empty($soyad) && !empty($telefon) && !empty($email) && !empty($parol))
    {
      ...
      {echo'<div class="alert alert-warning" role="alert">Tesdiq parolu yalnisdir!</div>';}
} 
 ?>
<?php 
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="ad" value="'.$_SESSION['ad'].'">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="soyad" value="'.$_SESSION['soyad'].'">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Number</label>
                    <input class="form-control" type="text" name="telefon" value="'.$_SESSION['telefon'].'">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Password</label>
                    <input class="form-control" name="parol" type="password" value="">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" name="yparol" type="password" value="">
                  </div>
                </div>
              </div><br>
              <button type="submit" name="update" class="btn btn-primary btn-sm ms-auto">Update</button>
            </div>
          </div>
        </div>
