...
<head>
  ...
  <title>My Storage | Sign up </title>
  <!--     Fonts and icons     -->
      ...
      <div class="col-12">
        ...
        <nav class="navbar navbar-expand-lg blur border-radius-lg top-0 z-index-3 shadow position-absolute mt-4 py-2 start-0 end-0 mx-4">
          <div class="container-fluid">
            <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 " href="../pages/brands.php">My Storage</a>
              ...
              <ul class="navbar-nav mx-auto">                
                <li class="nav-item">
                  <a class="nav-link me-2" href="../pages/sign-up.php">
                    <i class="fas fa-user-circle opacity-6 text-dark me-1"></i>Sign Up</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link me-2" href="../pages/sign-in.php">
                    <i class="fas fa-key opacity-6 text-dark me-1"></i>Sign In</a>
                </li>
              </ul>             
            </div>
          </div>
              ...
              <div class="card card-plain">
                ...
                <div class="card-body">
                  ...
                  <form role="form">
                    ...
                    <div class="mb-3">
                      <input type="password" class="form-control form-control-lg" name="parol" placeholder="Password" aria-label="Password">
                    </div>
                    ...
                    <div class="text-center">
                      <button class="btn btn-lg btn-primary btn-lg w-100 mt-4 mb-0" type="submit" name="in" >Sign in</button>
                    </div>
                  </form>
                </div>
